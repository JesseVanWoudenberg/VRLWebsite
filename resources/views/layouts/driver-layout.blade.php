    ...
    <body class="driver-panel-body">
        ...
        <header class="driver-panel-nav" id="driver-nav">
            ...
            <div class="menu-button-wrapper">
                <div class="menu-toggle" id="driver-menu-toggle">
            ...
            <nav>
                <ul>
                    ...
                    <li class="driver-home-link">
                        <a href="{{ route('driverpanel.availability') }}">
                    ...
                    <li>
                        <div class="requests-dropdown-container dropdown-container">
                            <button class="dropdown-activator-button">
                                    ...
                                    <li>
                                        <div class="link-container">
                                            <a href="{{ route('driverpanel.requests.drivernumber.create') }}">
                                                ...
                                                <span>Driver number change</span>
                                            </a>
                                        </div>
                                    </li>
        ...
        <script src="{{ asset('resources/javascript/driver-nav.js') }}"></script>
    </body>
</html>
